...
/**
 * Regression test for KON-1714 — IAB OMID compliance flagged duplicate
 * volumeChange events on v3 sdk-kotlin video and interstitial ads. Root
 * cause: the `addDocumentStartJavaScript` calls in `baseAdSetup` used
 * `setOf("*")`, which also injected omsdk-v1.js into the verification
 * iframes that omsdk-v1.js itself creates for VAST adVerifications.
 * The fix scopes the rule to the ad server origin only.
 */
