...
/**
 * Traditional-View (RecyclerView) demo screen — the customer's integration
 * shape, restored from the v2.0.1 example. Ads render through
 ...
 * (no Compose `AndroidView` wrapper in the way).
 */
